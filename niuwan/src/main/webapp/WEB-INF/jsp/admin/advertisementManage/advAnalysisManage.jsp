<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
 ...
 <body class="flat-blue">
 							...
 							<div class="card">
 								<div class="card-header">
 									<div class="card-title">
 										<div class="row">
											<form role="form" class="form-horizontal" id="searchForm" action="<%=basePath%>advertisement/advAnalysisManage" method="post">
 												<div class="col-xs-3">
 												...
 												<div class="col-xs-3">
 													<div class="input-group" style="margin-top: 5px;">
														<span class="input-group-addon">开始时间</span> <input type="date" class="form-control" name="startdate" id="searchStartdate" value="${startdate}" autocomplete="off">
 													</div>
 												</div>
												<div class="col-xs-3">
													<div class="input-group" style="margin-top: 5px;">
														<span class="input-group-addon">结束时间</span> <input type="date" class="form-control" name="enddate" id="searchEnddate" value="${enddate}" autocomplete="off">
													</div>
												</div>
 												<div class="col-xs-1">
												...
												<div class="col-xs-2">
													<button type="button" class="btn btn-info btn-block" onclick="toDownload()">导出报表</button>
												</div>
 											</form>
 										</div>
 									</div>
	...
	<script type="text/javascript" src="<%=basePath%>resources/admin/advAnalysisManage.js"></script>
