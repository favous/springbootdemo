...
<body class="flat-blue">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<div class="row">
											<form role="form" class="form-horizontal" id="searchForm" action="<%=basePath%>advertisement/advAuditManage" method="post">
												<div class="col-xs-3">
	...
	<script type="text/javascript" src="<%=basePath%>resources/admin/advAuditManage.js"></script>
</body>
</html>
