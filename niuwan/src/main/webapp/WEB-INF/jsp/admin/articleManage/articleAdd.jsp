		...
		<div class="row content-container">
			...
			<div class="container-fluid">
				<div class="side-body">
					...
					<div class="row">
						<div class="col-xs-12">
							<form role="form" action="<%=basePath %>article/addarticle"
								method="post" id="myform">
								<div class="form-group">
									<label for="name" style="width: 100%;">封面图片</label> <img alt="" id="Pic"
										src="<%=basePath %>resources/images/moren.png"
								...
								<div class="form-group">
									<label for="name">标题</label> <input type="text"
										class="form-control" id="articleTitle" name="articleTitle" placeholder="请输入标题">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" name="articleAbstract" id="articleAbstract"></textarea>
								</div>
								<div class="form-group">
								...
								<button type="button" class="btn btn-default" onclick="addarticle()">发布</button>
							</form>
			...
			/* if(!fileInput){
				...
				$("#myform").ajaxSubmit({
					...
					success : function(data) {
						if (data == "success") {
							alert("添加成功！");
							window.location.href = "article/articleAdd"
						} else {
							alert("修改失败！");
						}
					}
