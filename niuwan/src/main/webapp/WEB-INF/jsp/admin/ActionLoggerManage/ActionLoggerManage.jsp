...
<body class="flat-blue">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<div class="row">
											<form role="form" class="form-horizontal" id="searchForm" action="<%=basePath%>actionLogger/actionLoggerManage" method="post" autocomplete="off">
												<div class="col-xs-3" style="margin-top: 5px;">
														<div class="input-group">
															<span class="input-group-addon">开始日期</span> <input type="date" name="startTime" id="startTime" class="form-control" value="${startTime}" placeholder="请选择开始日期..">
														</div>
													</div>
													<div class="col-xs-3" style="margin-top: 5px;">
														<div class="input-group">
															<span class="input-group-addon">结束日期</span> <input type="date" name="endTime" id="endTime" class="form-control" value="${endTime}" placeholder="请选择结束日期..">
														</div>
													</div>
												<div class="col-xs-1">
	...
	<script type="text/javascript" src="<%=basePath%>resources/admin/ActionLoggerManage.js"></script>
</body>
</html>
